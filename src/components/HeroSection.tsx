        ...
        >
          ...
          >
            ...
            <div className="flex items-center space-x-4">
              {[
                { icon: Github, href: 'https://github.com/erislandy' },
                { icon: Linkedin, href: 'https://www.linkedin.com/in/erislandy-cabrales-reyes-898994131' },
                { icon: Mail, href: 'mailto:erislandy.cabrales@gmail.com' }

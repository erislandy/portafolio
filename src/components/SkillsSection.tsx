  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Nx', level: 95, color: 'from-blue-400 to-blue-600' },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Cosmos DB', level: 90, color: 'from-indigo-400 to-indigo-600' }
      ]
    },
    {
      ...
      skills: [
        ...
        { name: 'Node-RED', level: 92, color: 'from-red-600 to-red-800' },
        { name: 'Azure IoT Hub', level: 91, color: 'from-blue-500 to-blue-700' }
      ]
    }
  ]
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {[
              ...
              'Node-RED', 'IoT Hub', 'SignalR', 'SQL Server', 'Cosmos DB', 'Docker',
              'Git', 'Nx', 'DevExtreme', 'Semantic Kernel'
            ].map((tech, index) => (
              <motion.span
                key={tech}
